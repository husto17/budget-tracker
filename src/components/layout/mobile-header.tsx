...
export function MobileHeader() {
  return (
    <div className="md:hidden shrink-0 flex items-end px-4 pb-2 bg-gray-50 dark:bg-gray-950 border-b border-gray-100 dark:border-gray-800" style={{ paddingTop: "calc(env(safe-area-inset-top) + 8px)" }}>
      <button
